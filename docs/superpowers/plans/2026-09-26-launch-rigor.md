...
- **Every third-party action is pinned to a full commit SHA with a `# vX.Y.Z` comment**, like every existing workflow. SHAs resolved 2026-09-26: `ossf/scorecard-action@2d1146689b8cda280b9bc96326124645441f03bc # v2.4.4`; `actions/attest-build-provenance@4d101475d8b20a2381f78447822ac1eab6504dd8 # v4.2.2`; `actions/attest-sbom@c604332985a26aa8cf1bdc465b92731239ec6b9e # v4.1.0`; `sigstore/cosign-installer@6f9f17788090df1f26f669e9d70d6ae9567deba6 # v4.1.2`; `anchore/sbom-action@3ad7283483fc7af8ff2b4ea19663c2d5ca935e26 # v0.24.2`; `github/codeql-action/upload-sarif@2892aa5e19bbd11bc0cff5427e3b750a04d9e3c2 # v4.38.2`. Reuse the repo's existing pins for `actions/checkout` (`3d3c42e5aac5ba805825da76410c181273ba90b1 # v7.0.1`) and `actions/upload-artifact` (`043fb46d1a93c77aae656e7c1c64a875d1fc6a0a # v7.0.1`).
